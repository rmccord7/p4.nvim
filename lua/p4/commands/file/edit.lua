...
function M.add_parser(parent_sub_parser)
  ...
  parser:set_execute(function()
    ...
    if vim.api.nvim_buf_is_valid(buf) then
      ...
      local success, file_list, file_error_list = xpcall(file_api.edit, error_handler_api.process, file_name)
      ...
      if success then
        ...
        if #files > 0 then
          ...
          notify(string.format("%s opened for edit", file:get_info().path))
