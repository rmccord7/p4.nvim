...
--- @class P4_Command_Files_Result_Success :  P4_Command_Common_Result_Success
...
--- @class P4_Command_Files_Result : P4_Command_Common_Result
...
setmetatable(P4_Command_Files, { __index = cmd_lib })
...
--- @param results P4_Command_Files_Result[] Hold's the filtered results.
---
--- @package
function P4_Command_Files:_cmd_result_success_handler(cmd_result, results)
  local cmd_result_success = cmd_result.data

  ---@cast cmd_result_success P4_Command_Files_Result_Success
...
---
--- @package
function P4_Command_Files:_cmd_result_error_handler(cmd_result, results)
